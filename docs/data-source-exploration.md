...
> **Preserved research notes:** This document contains the original feature
> brainstorming, API/library investigation, code snippets, and captured sample
> output that previously lived in the root README. The organized project
> overview and roadmap are now in [README.md](../README.md); the material here
> remains available so no research information is lost.
...
Check [this google sheet](Portfolio%20Analysis.xlsx) for a sample portfolio analysis.
...
1) Diversification analysis: ![alt text](../images/workflow-image.png)
2) net xirr
3) fund wise xirr: ![alt text](../images/workflow-image-1.png)
4) top performing and lagging funds
5) portfolio over time: ![alt text](../images/workflow-image-2.png)
